...
| MS-606 | Excluir conversa por long-press ou duplo clique com ícone animado (Framer Motion) — TDD backend+frontend, cobertura ≥85% | `frontend` `backend` `feature` `testing` |
